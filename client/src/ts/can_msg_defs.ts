...
export const enum CanDevice {
  ...
  CAN_DEVICE_DRIVER_CONTROLS_PEDAL = 8,
  CAN_DEVICE_DRIVER_CONTROLS_CENTER_CONSOLE = 9,
  CAN_DEVICE_SOLAR_MASTER_FRONT = 10,
  CAN_DEVICE_SOLAR_MASTER_REAR = 11,
  CAN_DEVICE_SENSOR_BOARD = 12,
  CAN_DEVICE_CHARGER = 13,
  CAN_DEVICE_DRIVER_CONTROLS_STEERING = 14,
  NUM_CAN_DEVICES = 15
}
...
export const enum CanMessage {
  ...
  CAN_MESSAGE_SET_MODULE_DISCHARGE = 21,
  CAN_MESSAGE_DISCHARGE_STATE = 22,
  ...
  CAN_MESSAGE_STEERING_EVENT = 28,
  CAN_MESSAGE_CENTER_CONSOLE_EVENT = 29,
  CAN_MESSAGE_MOTOR_CONTROLLER_RESET = 30,
  ...
  CAN_MESSAGE_GPS_UTC_TIME = 53,
  CAN_MESSAGE_GPS_LONGITUDE_AND_SATELITES_USED = 54,
  CAN_MESSAGE_GPS_LATITUDE_AND_POSITION_FIX_INDICATOR = 55,
  CAN_MESSAGE_GPS_SPEED_AND_TRUE_HEADING = 56,
  NUM_CAN_MESSAGES = 44
}
